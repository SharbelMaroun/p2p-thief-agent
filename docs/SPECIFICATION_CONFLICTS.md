...
| C-008 | Appendix B `schema_version` example `1.2` versus official templates `1.1` | `OPEN` | Record both; do not normalize or freeze a supported version yet | PDF p.129; template hashes; ADR-0003 |
