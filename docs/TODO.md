...
- [x] Move unverified Thief configs to `config/drafts/thief/`.
- [x] Archive opposite-role Cop configs outside `config/`.
...
Phase 1 remains blocked until affected requirements are `CONFIRMED`.
