...
| M5-011 | Prove the runtime under adversarial peer behaviour | DONE | `test_adversarial_peer.py` gathers all five hostile classes into one proof exercising the real guard paths; each sub-task below is a named test |
